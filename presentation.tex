...
\begin{frame}{How do humans perform tasks together?}
    ...
    \pause
        ...
        The key mecanism: {\bf prefer implict to explicit}!

    \pause

        ...which is closely related to: {\bf attempt first simple
        -- yet possibly ambiguous -- actions, and repair only when needed}
    \end{center}
...
\section{Supervision for Progressive Autonomy}
...
000 states;
5 actions}, color=black]{sparc/sophies}
